...
class MiniorangeWebsiteSecurityVerificationCustomer {
  ...
  public function checkCustomer() {
    ...
    if (curl_errno($ch)) {
      $error = array(
        ...
        '%file' => 'MiniorangeWebsiteSecurityVerificationCustomer.php',
        '%error' => curl_error($ch),
      );
      watchdog('security_login_secure', 'Error at %method of %file: %error', $error);
    }
    curl_close($ch);
  ...
  public function createCustomer() {
    ...
    $fields = array(
      ...
      'areaOfInterest' => 'DRUPAL 8 Website Security',
      'email' => $this->email,
      'phone' => $this->phone,
  ...
  public function sendOtp() {
    ...
    $username = \Drupal::config('security_login_secure.settings')->get('website_security_customer_admin_email');
